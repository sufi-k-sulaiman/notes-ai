    ...
    <>
            ...
            <div className={`notes-app-container min-h-screen p-3 md:p-6 xl:p-0 ${darkMode ? 'bg-[#0c0f1f]' : 'bg-white'}`} style={{ paddingTop: 'max(0.75rem, env(safe-area-inset-top))', paddingBottom: 'max(0.75rem, env(safe-area-inset-bottom))', paddingLeft: 'max(0.75rem, env(safe-area-inset-left))', paddingRight: 'max(0.75rem, env(safe-area-inset-right))' }}>
                <div className="max-w-7xl xl:max-w-none mx-auto xl:mx-0">
                  ...
                  className="w-12 h-12 md:w-14 md:h-14 rounded-xl" />
                                ...
                                <div>
                                    <h1 className="text-gray-900 text-sm font-bold" style={{ fontSize: '1.25rem' }}>Notes Ai</h1>
          ...
          'bg-white/40 border-white/60'}`
            ...
            <footer className={`mt-12 py-6 border-t text-center text-sm ${darkMode ? 'border-gray-700/50 text-gray-400' : 'border-gray-200/50 text-gray-600'}`}>
              <p>© 2026 Developed by <a href="https://sufikhan.com/" target="_blank" rel="noopener noreferrer" title="Sufi Khan Sulaiman - 20+ years of building scalable Ecommerce solutions" className="text-purple-600 hover:text-purple-700 dark:text-purple-400 dark:hover:text-purple-300 underline">Sufi Khan Sulaiman</a>. All rights reserved.</p>
            </footer>
                </>);
